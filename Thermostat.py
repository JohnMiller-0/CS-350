...
class TemperatureMachine(StateMachine):
    ...
    def on_enter_heat(self):
        ## Pulse the red light to indicate heating
        redLight.pulse()
    ...
    def on_enter_cool(self):
        ## Pulse the blue light to indicate cooling
        blueLight.pulse()
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state.id}ing to: {self.setPoint}F"
                altCounter += 1
            ...
            if((counter % 30) == 0):
                ## Write the current state information to the TemperatureServer
...
##
redButton = Button(25)
## Process increase temperature button
...
## Process decrease temperature button
